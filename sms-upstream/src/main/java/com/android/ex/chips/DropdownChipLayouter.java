...
public class DropdownChipLayouter {
    ...
    /**
     * Helper method to return styled display name and destination.
     * Subclasses can override to provide custom styling (e.g., bold matching text).
     *
     * @param substring The search substring (for highlighting)
     * @param displayName The contact display name
     * @param destination The contact destination (phone/email)
     * @return Array of [styledDisplayName, styledDestination]
     */
