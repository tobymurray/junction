...
//            showAlternates(newChip, mAlternatesPopup, getWidth());
   ...
   public boolean lastCharacterIsCommitCharacter(CharSequence s) {
    ...
    /**
     * Append a recipient entry to the chip view.
     * Compatibility method for Messaging app integration.
     *
     * @param entry The recipient entry to add
     */
    ...
    /**
     * Remove a recipient entry from the chip view.
     * Compatibility method for Messaging app integration.
     *
     * @param entry The recipient entry to remove
     */
    public void removeRecipientEntry(RecipientEntry entry) {
        ...
        // Find and remove the chip matching this entry
        DrawableRecipientChip[] chips = getSortedRecipients();
        if (chips != null) {
            for (DrawableRecipientChip chip : chips) {
                if (chip.getEntry().equals(entry)) {
                    removeChip(chip);
                    break;
                }
            }
